...
typedef enum _RomLocation {
	...
	ROM_LOCATION_GAME_NAME_END = 0x13E,
	ROM_LOCATION_CART_TYPE = 0x147
} RomLocation;


typedef enum _RamLocation {
	RAM_LOCATION_ROM_FIXED = 0x0,
	RAM_LOCATION_ROM_FIXED_END = 0x3fff,
	RAM_LOCATION_ROM_SWITCHABLE = 0x4000,
	RAM_LOCATION_ROM_SWITCHABLE_END = 0x7fff,
	...
	RAM_LOCATION_SOUND_CHANNEL_4_LENGTH = 0xFF20, //NR41 - Channel 4 Sound_Length
	...
	RAM_LOCATION_SOUND_CHANNEL_4_SETTINGS = 0xFF23, //NR44 - Channel 4 Counter/consecutive, Inital
	RAM_LOCATION_SOUND_MASTER_LR_VOLUME = 0xFF24, //NR50 - Master volume controls for left & right
	RAM_LOCATION_SOUND_CHANNEL_LR_ENABLE = 0xFF25, //NR51 - Individual sound channel left & right enable
	RAM_LOCATION_SOUND_ENABLE = 0xFF26,
...
typedef enum _SoundFlag {
	...
	SOUND_MASK_VOLUME_SWEEP_INITIAL = 0xF0,
	SOUND_MASK_VOLUME_SWEEP_INCREASE = 0x8,
	SOUND_MASK_SOUND_LENGTH_ENABLED = 0x40,
	SOUND_MASK_SOUND_LENGTH_6_BIT = 0x3F,
	SOUND_MASK_SOUND_LENGTH_8_BIT = 0xFF,
	SOUND_MASK_CHAN3_VOLUME = 0x60,
	SOUND_MASK_CHAN4_CLOCK_FREQUENCY = 0xF0,
	SOUND_MASK_CHAN4_7BIT_MODE = 0x8,
	SOUND_MASK_CHAN4_DIVIDING_RATIO = 0x7,

	SOUND_MASK_FREQUENCY_HIGH_BITS = 0x7,
	SOUND_MASK_VOLUME_SWEEP_STEP = 0x7,
	SOUND_MASK_MASTER_VOLUME_LEFT = 0x70,
	SOUND_MASK_MASTER_VOLUME_RIGHT = 0x7,
	SOUND_MASK_ENABLE_LEFT_CHAN_4 = 0x80,
	SOUND_MASK_ENABLE_LEFT_CHAN_3 = 0x40,
	SOUND_MASK_ENABLE_LEFT_CHAN_2 = 0x20,
	SOUND_MASK_ENABLE_LEFT_CHAN_1 = 0x10,
	SOUND_MASK_ENABLE_RIGHT_CHAN_4 = 0x8,
	SOUND_MASK_ENABLE_RIGHT_CHAN_3 = 0x4,
	SOUND_MASK_ENABLE_RIGHT_CHAN_2 = 0x2,
	SOUND_MASK_ENABLE_RIGHT_CHAN_1 = 0x1,
...
#define SWITCHABLE_CART_ROM_ADDRESS_SIZE 0x4000
#define SWITCHABLE_CART_RAM_ADDRESS_SIZE 0x2000
#define ROM_ONLY_RAM_SIZE 0x2000
#define MBC1_RAM_SIZE 0x8000
