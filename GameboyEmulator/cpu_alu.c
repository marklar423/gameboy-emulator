...
void populateALUOperands1(Hardware *hardware, InstructionMapping *mappings) {
	...
	mappings[OpCode_ADC_A_A].operand1 =
		...
		mappings[OpCode_ADC_A_d8].operand1 = createGBByteValue(&(hardware->computedFunctions->APlusCarry));
	...
	mappings[OpCode_SBC_A_A].operand1 =
		...
		mappings[OpCode_SBC_A_d8].operand1 = createGBByteValue(&(hardware->computedFunctions->AMinusCarry));
	...
	mappings[OpCode_INC_BC].operand1 =
		mappings[OpCode_DEC_BC].operand1 = createGBWordValue(&(hardware->computedFunctions->BC));
	...
	mappings[OpCode_INC_DE].operand1 =
		mappings[OpCode_DEC_DE].operand1 = createGBWordValue(&(hardware->computedFunctions->DE));
	...
	mappings[OpCode_ADD_HL_BC].operand1 =
		...
		mappings[OpCode_DEC_HL].operand1 = createGBWordValue(&(hardware->computedFunctions->HL));
	...
	mappings[OpCode_INC_MEM_HL].operand1 =
		mappings[OpCode_DEC_MEM_HL].operand1 = createGBBytePointer(&(hardware->computedFunctions->memoryHL));
...
void populateALUOperands2(Hardware *hardware, InstructionMapping *mappings) {
	...
	mappings[OpCode_ADC_A_MEM_HL].operand2 =
		...
		mappings[OpCode_XOR_MEM_HL].operand2 = createGBBytePointer(&(hardware->computedFunctions->memoryHL));
	...
	mappings[OpCode_ADC_A_d8].operand2 =
		...
		mappings[OpCode_XOR_d8].operand2 = createGBByteValue(&(hardware->computedFunctions->immediateByte));


	mappings[OpCode_ADD_HL_BC].operand2 = createGBWordValue(&(hardware->computedFunctions->BC));
	mappings[OpCode_ADD_HL_DE].operand2 = createGBWordValue(&(hardware->computedFunctions->DE));
	mappings[OpCode_ADD_HL_HL].operand2 = createGBWordValue(&(hardware->computedFunctions->HL));
	...
	mappings[OpCode_ADD_SP_r8].operand2 = createGBByteValueSigned(&(hardware->computedFunctions->immediateByte));
...
void populateALUDestinations(Hardware *hardware, InstructionMapping *mappings) {
	...
	mappings[OpCode_INC_MEM_HL].destination =
		mappings[OpCode_DEC_MEM_HL].destination = createGBBytePointer(&(hardware->computedFunctions->memoryHL));
